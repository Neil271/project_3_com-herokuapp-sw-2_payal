...
public class Programme_4_NumbersOfDaysInMonth {
    public static void main(String[] args) {
        ...
        System.out.println(getDaysIsMonth(1, 2020));
        System.out.println(getDaysIsMonth(2, 2020));
        System.out.println(getDaysIsMonth(2, 2018));
        System.out.println(getDaysIsMonth(-1, 2020));
        System.out.println(getDaysIsMonth(1, -2020));
    ...
    public static int getDaysIsMonth(int month, int year){
        int days=0;
